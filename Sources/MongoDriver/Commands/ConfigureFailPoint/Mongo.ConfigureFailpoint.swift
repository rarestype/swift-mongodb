...
extension Mongo {
    ...
    @frozen public enum ConfigureFailpoint<Options>: Sendable where Options: Mongo.Failpoint {
        case always(Options)
...
extension Mongo.ConfigureFailpoint {
    @inlinable public static func once(_ options: Options) -> Self {
...
extension Mongo.ConfigureFailpoint: Mongo.ImplicitSessionCommand, Mongo.Command {
    ...
    @inlinable public static var type: Mongo.CommandType { .configureFailpoint }
