...
extension Mongo {
    public struct ReplicaSetConfiguration: Equatable, Sendable {
        public let name: String
        public let writeConcernMajorityJournalDefault: Bool
...
extension Mongo.ReplicaSetConfiguration: BSONDocumentDecodable {
    @inlinable public init(bson: BSON.DocumentDecoder<CodingKey>) throws {
        self.init(
            name: try bson[.id].decode(),
            writeConcernMajorityJournalDefault: try bson[
