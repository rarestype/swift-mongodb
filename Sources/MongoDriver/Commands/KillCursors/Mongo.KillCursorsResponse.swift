...
extension Mongo {
    public struct KillCursorsResponse: Sendable {
        public let alive: [CursorIdentifier]
        public let killed: [CursorIdentifier]
        public let notFound: [CursorIdentifier]
        public let unknown: [CursorIdentifier]

        public init(
            alive: [CursorIdentifier],
