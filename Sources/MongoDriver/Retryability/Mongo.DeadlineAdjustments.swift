extension Mongo {
    @frozen @usableFromInline struct DeadlineAdjustments: Sendable {
        ...
        @usableFromInline let logical: ContinuousClock.Instant
        ...
        @usableFromInline let network: ContinuousClock.Instant
