...
extension Mongo {
    public struct DeploymentStateError<Underlying>: Error where Underlying: Error {
        public let diagnostics: Mongo.SelectionDiagnostics
        public let failure: Underlying

        public init(diagnostics: Mongo.SelectionDiagnostics, failure: Underlying) {
