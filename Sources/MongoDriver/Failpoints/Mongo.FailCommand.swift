...
extension Mongo {
    ...
    public struct FailCommand: Sendable {
        public let behavior: Behavior?
        public let appname: String?
        public let types: [CommandType]

        public init(behavior: Behavior?, appname: String?, types: [CommandType]) {
...
extension Mongo.FailCommand: Mongo.Failpoint {
    ...
    @inlinable public static var name: String { "failCommand" }
}
