...
extension Mongo.ReadPreference {
    public struct Eligibility: Equatable, Sendable {
        public let maxStaleness: Seconds?
        public let tagSets: [TagSet]?
        ...
        @inlinable public init(maxStaleness: Seconds?, tagSets: [TagSet]?) {
...
extension Mongo.ReadPreference.Eligibility {
    func diagnose(
        unsuitable: [Mongo.Server<Mongo.ReplicaQuality>]
