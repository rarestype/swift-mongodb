...
extension Mongo {
    @frozen public enum ReadPreference: Equatable, Sendable {
...
extension Mongo.ReadPreference {
    @inlinable public static var secondary: Self {
        .secondary(.init())
    }
    @inlinable public static var secondaryPreferred: Self {
        .secondaryPreferred(.init())
    }
    @inlinable public static var nearest: Self {
        .nearest(.init())
    }
    @inlinable public static var primaryPreferred: Self {
        .primaryPreferred(.init())
    }
}
extension Mongo.ReadPreference {
    @inlinable public static func secondary(
        maxStaleness seconds: Seconds? = nil,
        tagSets: [TagSet]? = nil,
        hedge hedging: Hedging? = nil
    ) -> Self {
        .secondary(
            .init(maxStaleness: seconds, tagSets: tagSets),
            hedge: hedging
        )
    }
    @inlinable public static func secondaryPreferred(
        maxStaleness seconds: Seconds? = nil,
        tagSets: [TagSet]? = nil,
        hedge hedging: Hedging? = nil
    ) -> Self {
    ...
    @inlinable public static func nearest(
        maxStaleness seconds: Seconds? = nil,
        tagSets: [TagSet]? = nil,
        hedge hedging: Hedging? = nil
    ) -> Self {
    ...
    @inlinable public static func primaryPreferred(
        maxStaleness seconds: Seconds? = nil,
        tagSets: [TagSet]? = nil,
        hedge hedging: Hedging? = nil
    ) -> Self {
...
extension Mongo.ReadPreference: BSONEncodable, BSONDocumentEncodable {
    public func encode(to bson: inout BSON.DocumentEncoder<BSON.Key>) {
        bson["mode"] = self.mode
...
extension Mongo.ReadPreference {
    func diagnose(servers: Mongo.ServerTable) -> Mongo.SelectionDiagnostics {
        ...
        case .replicated(let members):
            ...
            switch self {
            case    .primary:
                undesirable = members.candidates.secondaries.reduce(
                    into: members.undesirables
                ) {
                    $0[$1.host] = .secondary
                }
                unsuitable = [:]
            ...
            return .init(
                unreachable: members.unreachables,
