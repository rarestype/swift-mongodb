...
extension Mongo.Authenticator {
    ...
    /// be closed.
    func establish(
        _ connection: Mongo.ConnectionPool.Allocation,
...
extension Mongo.Authenticator {
    private nonisolated func authenticate(
        _ connection: Mongo.ConnectionPool.Allocation,
    ...
    private nonisolated func authenticate(
        ...
        //  '''
        guard 4096 ... 310_000 ~= challenge.iterations else {
        ...
        guard client.verify(server) else {
