...
extension Mongo.ConnectionPool {
    @usableFromInline internal struct Allocation: MongoExecutor, Sendable {
...
extension Mongo.ConnectionPool.Allocation {
    ...
    func run(
        hello command: __owned Mongo.Hello,
        by deadline: ContinuousClock.Instant
    ) async throws -> Set<Mongo.Authentication.SASL>? {
