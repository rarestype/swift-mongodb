...
extension Mongo.Accumulator {
    @frozen public struct SuperlativeSortDocument<Count>: Mongo.EncodableDocument, Sendable {
...
extension Mongo.Accumulator.SuperlativeSortDocument {
    ...
    @inlinable public subscript(key: Mongo.SortBy) -> Mongo.SortDocument<Mongo.AnyKeyPath>? {
        nil
    }
...
extension Mongo.Accumulator.SuperlativeSortDocument {
    ...
    @inlinable public subscript<Encodable>(key: Output) -> Encodable?
...
extension Mongo.Accumulator.SuperlativeSortDocument<Mongo.Accumulator.N> {
    ...
    @inlinable public subscript<Encodable>(key: Mongo.Accumulator.N) -> Encodable?
        where Encodable: BSONEncodable {
        get {
            nil
        }
