...
extension Mongo {
    @frozen public struct LookupEncoder: Sendable {
...
extension Mongo.LookupEncoder {
    @frozen public enum Field: String, Hashable, Sendable {
        case `as`
        case localField
        case foreignField
    }
...
extension Mongo.LookupEncoder {
    @frozen public enum From: String, Hashable, Sendable {
        case from
    }

    @inlinable public subscript(key: From) -> Mongo.Collection? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.LookupEncoder {
    ...
    @available(*, unavailable)
    @inlinable public subscript(key: Pipeline) -> Mongo.Pipeline? { nil }

    @inlinable public subscript(
        key: Pipeline,
        yield: (inout Mongo.PipelineEncoder) -> () = { _ in }
    ) -> Void {
        mutating get {
    ...
    @inlinable public subscript<Encodable>(
        key: Pipeline
    ) -> Encodable? where Encodable: Mongo.PipelineEncodable {
        get {
            nil
        }
        set(value) {
