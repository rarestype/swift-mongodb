...
extension Mongo {
    @frozen public struct UpdateEncoder: Sendable {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Arithmetic: String, Hashable, Sendable {
        case inc = "$inc"
        case mul = "$mul"
    }
    ...
    @inlinable public subscript(
        key: Arithmetic,
        yield: (inout Mongo.UpdateFieldsEncoder<Arithmetic>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Assignment: String, Sendable, Mongo.UpdateValueOperator {
        case set = "$set"
    ...
    @inlinable public subscript<Replacement>(key: Assignment) -> Replacement?
    ...
    @inlinable public subscript(
        key: Assignment,
        yield: (inout Mongo.UpdateFieldsEncoder<Assignment>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Bit: String, Sendable {
        case bit = "$bit"
    }

    @inlinable public subscript(
        key: Bit,
        yield: (inout Mongo.UpdateFieldsEncoder<Bit>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum CurrentDate: String, Sendable {
        case currentDate = "$currentDate"
    }

    @inlinable public subscript(
        key: CurrentDate,
        yield: (inout Mongo.UpdateFieldsEncoder<CurrentDate>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Pop: String, Sendable {
        case pop = "$pop"
    }

    @inlinable public subscript(
        key: Pop,
        yield: (inout Mongo.UpdateFieldsEncoder<Pop>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Pull: String, Sendable, Mongo.UpdateValueOperator {
        case pull = "$pull"
    }

    @inlinable public subscript(
        key: Pull,
        yield: (inout Mongo.UpdateFieldsEncoder<Pull>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Reduction: String, Sendable, Mongo.UpdateValueOperator {
        case max = "$max"
        case min = "$min"
    ...
    @inlinable public subscript(
        key: Reduction,
        yield: (inout Mongo.UpdateFieldsEncoder<Reduction>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum Rename: String, Sendable {
        case rename = "$rename"
    }

    @inlinable public subscript(
        key: Rename,
        yield: (inout Mongo.UpdateFieldsEncoder<Rename>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    @frozen public enum ArrayUnion: String, Sendable, Mongo.UpdateValueOperator {
    ...
    @inlinable public subscript(
        key: ArrayUnion,
        yield: (inout Mongo.UpdateFieldsEncoder<ArrayUnion>) -> ()
    ) -> Void {
        mutating get {
...
extension Mongo.UpdateEncoder {
    ...
    @frozen public enum Unset: String, Sendable {
        case unset = "$unset"
    }

    @inlinable public subscript(
        key: Unset,
        yield: (inout Mongo.UpdateFieldsEncoder<Unset>) -> ()
    ) -> Void {
        mutating get {
