...
extension Mongo {
    @frozen public struct UpdateFieldsEncoder<Operator>: Sendable {
        @usableFromInline var bson: BSON.DocumentEncoder<Mongo.AnyKeyPath>

        @inlinable internal init(bson: BSON.DocumentEncoder<Mongo.AnyKeyPath>) {
            self.bson = bson
        }
    }
}
...
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Arithmetic> {
    ...
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> Double? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Assignment> {
    @inlinable public subscript(
        ...
        mutating get { yield(&self.bson[with: path][as: Mongo.ExpressionEncoder.self]) }
    }
}
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Bit> {
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> (
        operator: Mongo.UpdateBitwiseOperator,
        int32: Int32
    )? {
        get {
            nil
...
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.CurrentDate> {
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> UnixMillisecond.Type? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Pop> {
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> Mongo.UpdatePosition? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Pull> {
    @inlinable public subscript(
        path: Mongo.AnyKeyPath,
        yield: (inout Mongo.PredicateOperatorEncoder) -> ()
    ) -> Void {
        mutating get { yield(&self.bson[with: path][as: Mongo.PredicateOperatorEncoder.self]) }
    }
}
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.ArrayUnion> {
    @inlinable public subscript(
        path: Mongo.AnyKeyPath,
        yield: (inout Mongo.UpdateArrayEncoder) -> ()
    ) -> Void {
        mutating get { yield(&self.bson[with: path][as: Mongo.UpdateArrayEncoder.self]) }
    }
}
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Rename> {
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> Mongo.AnyKeyPath? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.UpdateFieldsEncoder<Mongo.UpdateEncoder.Unset> {
    ...
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> Bool {
        get {
            false
        }
        set(value) {
    ...
    @available(*, deprecated, message: """
        ...
        """)
    @inlinable public subscript(path: Mongo.AnyKeyPath) -> Void? {
        get {
            nil
        }
        set(value) {
