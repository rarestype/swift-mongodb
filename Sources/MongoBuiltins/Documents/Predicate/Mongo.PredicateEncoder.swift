...
extension Mongo {
    @frozen public struct PredicateEncoder: Sendable {
...
extension Mongo.PredicateEncoder {
    @available(*, deprecated, message: """
        ...
        """)
    public subscript<Expression>(path: Mongo.AnyKeyPath) -> Expression?
...
extension Mongo.PredicateEncoder {
    @frozen public enum Branch: String, Hashable, Sendable {
        case and    = "$and"
        case nor    = "$nor"
        case or     = "$or"
    }
...
extension Mongo.PredicateEncoder {
    @frozen public enum Comment: String, Hashable, Sendable {
...
extension Mongo.PredicateEncoder {
    @frozen public enum Expr: String, Hashable, Sendable {
        case expr = "$expr"
    }
