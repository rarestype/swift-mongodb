...
extension Mongo {
    @frozen public struct SortArrayDocument: Mongo.EncodableDocument, Sendable {
...
extension Mongo.SortArrayDocument {
    @frozen public enum Input: String, Sendable {
        case input
    }

    @inlinable public subscript<Encodable>(key: Input) -> Encodable?
