...
extension Mongo.Change {
    ...
    @frozen @usableFromInline struct UpdateDescription {
        @usableFromInline var updatedFields: Delta?
        @usableFromInline var removedFields: [Delta.Model.CodingKey]
        @usableFromInline var truncatedArrays: [
            Mongo.ChangeTruncatedArray<Delta.Model.CodingKey>
        ]
...
extension Mongo.Change.UpdateDescription: BSONDecodable, BSONDocumentDecodable {
    @frozen @usableFromInline enum CodingKey: String, Hashable, Sendable {
        case updatedFields
        case removedFields
    ...
    @inlinable init(bson: BSON.DocumentDecoder<CodingKey>) throws {
