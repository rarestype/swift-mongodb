...
extension Mongo.Change {
    ...
    @frozen public struct Update: Identifiable {
        public var updatedFields: Delta?
        public var removedFields: [Delta.Model.CodingKey]
        public var truncatedArrays: [Mongo.ChangeTruncatedArray<Delta.Model.CodingKey>]
        public var id: Delta.Model.ID
...
extension Mongo.Change.Update where Delta.Model.ID: BSONDecodable {
    @inlinable init(
        _ updateDescription: Mongo.Change<Delta>.UpdateDescription,
...
extension Mongo.Change.Update {
    @inlinable var updateDescription: Mongo.Change<Delta>.UpdateDescription {
        .init(
