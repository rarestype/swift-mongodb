...
extension Mongo {
    @frozen public struct WriteError: Equatable, Error, Sendable {
        public let index: Int
        public let code: Int32
        public let message: String

        @inlinable public init(index: Int, message: String, code: Int32) {
            self.index = index
...
extension Mongo.WriteError: BSONDocumentDecodable {
    @inlinable public init(bson: BSON.DocumentDecoder<BSON.Key>) throws {
        self.init(
            index: try bson["index"].decode(to: Int.self),
