...
extension Mongo {
    public struct CreateIndexes: Sendable {
        public let writeConcern: WriteConcern?
        public var fields: BSON.Document

        @usableFromInline internal init(writeConcern: WriteConcern?, fields: BSON.Document) {
...
extension Mongo.CreateIndexes: Mongo.Command {
    @inlinable public static var type: Mongo.CommandType { .createIndexes }

    public typealias Response = Mongo.CreateIndexesResponse
}
...
extension Mongo.CreateIndexes {
    @inlinable public subscript(key: CommitQuorum) -> Mongo.WriteConcern.Acknowledgement? {
        get {
            nil
        }
        set(value) {
