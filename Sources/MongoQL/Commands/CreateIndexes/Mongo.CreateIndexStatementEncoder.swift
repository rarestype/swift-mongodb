...
extension Mongo {
    @frozen public struct CreateIndexStatementEncoder: Sendable {
...
extension Mongo.CreateIndexStatementEncoder: Mongo.SortableEncoder {
    public typealias Sort = Key

    @frozen public enum Key: String, Hashable, Sendable {
        case key
    }
    ...
    @inlinable public subscript(key: Key) -> Mongo.SortDocument<Mongo.AnyKeyPath>? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.CreateIndexStatementEncoder {
    @frozen public enum Language: String, Hashable, Sendable {
        ...
        public static var default_language: Self { .languageDefault }

        @available(*, unavailable, renamed: "languageOverride")
        public static var language_override: Self { .languageOverride }
    }

    @available(*, unavailable, message: "unimplemented")
    @inlinable public subscript(key: Language) -> Never? {
        nil
    }
}
extension Mongo.CreateIndexStatementEncoder {
    @frozen public enum Name: String, Hashable, Sendable {
        case name
    }

    @inlinable public subscript(key: Name) -> String? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.CreateIndexStatementEncoder {
    @frozen public enum PartialFilterExpression: String, Hashable, Sendable {
        case partialFilterExpression
    }

    //  TODO: this is undertyped; only some of the query operators are allowed here.
    @inlinable public subscript(key: PartialFilterExpression) -> Mongo.PredicateDocument? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.CreateIndexStatementEncoder {
    @frozen public enum WildcardProjection: String, Hashable, Sendable {
