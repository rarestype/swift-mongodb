...
extension Mongo.CollectionOptions.Variant {
    @inlinable public var type: Mongo.CollectionType {
        switch self {
    ...
    @inlinable public var cap: (size: Int, max: Int?)? {
        switch self {
    ...
    @inlinable public var view: Mongo.CollectionView? {
        switch self {
        case .view(let view):
            view
        default:
