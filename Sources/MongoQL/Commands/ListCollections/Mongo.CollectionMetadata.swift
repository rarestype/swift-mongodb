...
extension Mongo {
    @frozen public struct CollectionMetadata: Sendable {
        public let collection: Collection
        public let options: CollectionOptions
        public let info: Info

        @inlinable public init(collection: Collection, options: CollectionOptions, info: Info) {
...
extension Mongo.CollectionMetadata {
    public var type: Mongo.CollectionType {
