...
extension Mongo {
    public struct Delete<Effect>: Sendable where Effect: Mongo.WriteEffect {
        public let writeConcern: WriteConcern?

        @usableFromInline internal var deletes: BSON.Output
...
extension Mongo.Delete: Mongo.Command {
    @inlinable public static var type: Mongo.CommandType { .delete }

    /// `Update` only supports retryable writes in single-write mode.
    public typealias ExecutionPolicy = Effect.ExecutionPolicy

    public typealias Response = Mongo.DeleteResponse

    @inlinable public var outline: Mongo.OutlineVector? {
...
extension Mongo.Delete {
    @inlinable public init(
        ...
        deletes encode: (inout Mongo.DeleteListEncoder<Effect>) throws -> ()
    ) rethrows {
...
extension Mongo.Delete {
    @frozen public enum Ordered: String, Equatable, Hashable, Sendable {
        case ordered
    }

    @inlinable public subscript(key: Ordered) -> Bool? {
        get {
            nil
        }
        set(value) {
