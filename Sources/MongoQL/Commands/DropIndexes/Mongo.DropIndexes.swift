...
extension Mongo {
    public struct DropIndexes: Sendable {
...
extension Mongo.DropIndexes: Mongo.Command {
    @inlinable public static var type: Mongo.CommandType { .dropIndexes }
}
...
extension Mongo.DropIndexes {
    @inlinable public subscript(key: Index) -> String? {
        get {
            nil
        }
        set(value) {
    ...
    @inlinable public subscript(key: Index) -> Mongo.PredicateDocument? {
        get {
            nil
        }
        set(value) {
