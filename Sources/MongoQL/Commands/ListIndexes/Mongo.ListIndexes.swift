...
extension Mongo {
    ...
    /// specifications.
    @frozen public struct ListIndexes<
        Element
    >: Sendable where Element: BSONDecodable & Sendable {
        public let stride: Int?

        public private(set) var fields: BSON.Document
...
extension Mongo.ListIndexes: Mongo.Command {
    ...
    @inlinable public static var type: Mongo.CommandType { .listIndexes }
...
extension Mongo.ListIndexes<Mongo.IndexBinding> {
    public init(_ collection: Mongo.Collection, stride: Int? = nil) {
