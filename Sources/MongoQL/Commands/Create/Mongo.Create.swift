...
extension Mongo {
    ...
    public struct Create<Mode>: Sendable {
...
extension Mongo.Create: Mongo.Command {
    @inlinable public static var type: Mongo.CommandType { .create }
}
...
extension Mongo.Create {
    ...
    @inlinable public subscript(key: StorageEngine) -> BSON.Document? {
        get {
            nil
        }
        set(value) {
...
extension Mongo.Create<Mongo.Collection> {
    @inlinable public subscript(key: Cap) -> (size: Int, max: Int?)? {
        get {
            nil
        }
        set(value) {
    ...
    @inlinable public subscript(key: ValidationAction) -> Mongo.ValidationAction? {
        get {
            nil
        }
        set(value) {
    ...
    @inlinable public subscript(key: ValidationLevel) -> Mongo.ValidationLevel? {
        get {
            nil
        }
        set(value) {
    ...
    @inlinable public subscript(key: Validator) -> Mongo.PredicateDocument? {
        get {
            nil
        }
        set(value) {
