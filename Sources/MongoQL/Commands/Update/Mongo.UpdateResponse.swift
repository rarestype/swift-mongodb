...
extension Mongo {
    public struct UpdateResponse<ID>: Sendable where ID: BSONDecodable & Sendable {
        ...
        public let upserted: [Updates<ID>.Upsertion]
...
extension Mongo.UpdateResponse {
    ...
    @inlinable public func updates() throws -> Mongo.Updates<ID> {
