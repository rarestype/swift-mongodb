extension Mongo.Topology {
    public struct Single {
        ...
        private var value: Mongo.ServerDescription<Mongo.Standalone, Owner>?
...
extension Mongo.Topology.Single {
    public var item: (
        key: Mongo.Host,
        value: Mongo.ServerDescription<Mongo.Standalone, Owner>
    )? {
        self.value.map { (self.host, $0) }
    }
}
extension Mongo.Topology.Single {
    public subscript(host: Mongo.Host) -> Mongo.ServerDescription<Mongo.Standalone, Owner>? {
        get {
