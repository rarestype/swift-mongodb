...
extension Mongo {
    ...
    @frozen public struct PrimaryBaseline: Sendable {
        public let update: ContinuousClock.Instant
        public let write: UnixMillisecond

        @inlinable public init(update: ContinuousClock.Instant, write: UnixMillisecond) {
            self.update = update
            self.write = write
        }
    }
...
extension Mongo.PrimaryBaseline {
    @inlinable public init(_ last: Mongo.ReplicaTimings) {
...
extension Mongo.PrimaryBaseline: Mongo.ReplicaTimingBaseline {
    ...
    @inlinable public static func - (
        self: Self,
        candidate: Mongo.ReplicaTimings
    ) -> Milliseconds {
        //  the formula is:
        //
