extension Mongo {
    @frozen public enum ServerDescription<Metadata, Owner> where Owner: AnyObject {
...
extension Mongo.ServerDescription {
    ...
    @inlinable public var owner: Owner? {
    ...
    @inlinable public var error: (any Error)? {
...
extension Mongo.ServerDescription {
    ...
    mutating func assign(error status: (any Error)?) -> Mongo.TopologyUpdateResult {
