...
extension Mongo {
    ...
    @frozen public struct Namespaced<Name> where Name: LosslessStringConvertible {
        public let database: Database
        public let name: Name

        @inlinable internal init(_ database: Database, _ name: Name) {
...
extension Mongo.Namespaced<Mongo.Collection> {
    @inlinable public var collection: Mongo.Collection {
        self.name
    }
}
