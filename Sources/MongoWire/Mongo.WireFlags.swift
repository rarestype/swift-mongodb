extension Mongo {
    @frozen public struct WireFlags: OptionSet, Sendable {
...
extension Mongo.WireFlags {
    ...
    /// for details.
    public static let checksumPresent: Self = .init(rawValue: 1 << 0)
    ...
    public static let moreToCome: Self = .init(rawValue: 1 << 1)
    ...
    public static let exhaustAllowed: Self = .init(rawValue: 1 << 16)

    @inlinable public init(validating flags: UInt32) throws {
