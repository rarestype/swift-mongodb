...
extension Mongo.WriteConcernError {
    public struct Details: Hashable, Sendable {
        public let acknowledgement: Mongo.WriteConcern.Acknowledgement
        public let provenance: Mongo.WriteConcernProvenance
        public let journaled: Bool?

        public init(
            acknowledgement: Mongo.WriteConcern.Acknowledgement,
