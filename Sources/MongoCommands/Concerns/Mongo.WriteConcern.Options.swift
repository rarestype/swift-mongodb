...
extension Mongo.WriteConcern {
    public struct Options: Hashable, Sendable {
        ...
        private init(unchecked acknowledgement: Acknowledgement, journaled: Bool?) {
...
extension Mongo.WriteConcern.Options {
    public init(acknowledgement: Mongo.WriteConcern.Acknowledgement, journaled: Bool? = nil) {
    ...
    public init(_ write: Mongo.WriteConcern) {
        self.init(unchecked: write.acknowledgement, journaled: write.journaled)
    }

    public static var unacknowledged: Self {
