...
extension Mongo.URI {
    ...
    @frozen public struct Authority<Login>: Sendable where Login: Mongo.LoginMode {
        public let userinfo: Login.Userinfo
        public let domains: Mongo.SeedingMethod

        @inlinable public init(userinfo: Login.Userinfo, domains: Mongo.SeedingMethod) {
...
extension Mongo.URI.Authority<Mongo.User> {
    @_disfavoredOverload
    @inlinable public static func / (self: Self, path: Mongo.Database) -> Mongo.URI.Location {
